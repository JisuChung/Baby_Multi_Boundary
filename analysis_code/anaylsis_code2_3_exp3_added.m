...
% load('250212_exp3_workplace.mat')
...
% 
% www_age_group = www_participant_info.age_yrfrac<=7.5 & www_participant_info.age_yrfrac>=5;
% exp1_age_group = Exp1_participant_info.age_yrfrac<=7.5 & Exp1_participant_info.age_yrfrac>=5;
% exp2_age_group = Exp2_participant_info.age_yrfrac<=7.5 & Exp2_participant_info.age_yrfrac>=5;
% exp3_age_group = Exp3_participant_info.age_yrfrac<=7.5 & Exp3_participant_info.age_yrfrac>=5;


www_age_group = www_participant_info.age_yrfrac<=10 & www_participant_info.age_yrfrac>=7.5;
exp1_age_group = Exp1_participant_info.age_yrfrac<=10 & Exp1_participant_info.age_yrfrac>=7.5;
exp2_age_group = Exp2_participant_info.age_yrfrac<=10 & Exp2_participant_info.age_yrfrac>=7.5;
exp3_age_group = Exp3_participant_info.age_yrfrac<=10 & Exp3_participant_info.age_yrfrac>=7.5;


% www_age_group = www_participant_info.age_yrfrac<=10 & www_participant_info.age_yrfrac>=5;
% exp1_age_group = Exp1_participant_info.age_yrfrac<=10 & Exp1_participant_info.age_yrfrac>=5;
% exp2_age_group = Exp2_participant_info.age_yrfrac<=10 & Exp2_participant_info.age_yrfrac>=5;
% exp3_age_group = Exp3_participant_info.age_yrfrac<=10 & Exp3_participant_info.age_yrfrac>=5;


% 
WWW_group_select = www_age_group & ~www_reject.sub_reject;
exp1_group_select =  exp1_age_group;
exp2_group_select =  exp2_age_group;
exp3_group_select =  exp3_age_group;

% WWW_group_select = ~www_reject.sub_reject;
% WWW_group_select = ~www_reject.sub_reject;

% MB_group_select = age_group & ~MB_reject.sub_reject;
% ctrl_group_select = ctrl_age_group & ~ctrl_reject.sub_reject;

Exp3_group_select = ones(size(Exp3_Behavior_table.age));
...
% purple / gray / pink / blue / green
color_palette = [.475 .392 .784; .471 .471 .510; .941 .510 .706; .392 .588 .941; .118 .686 .353];
light_color_palette = [.605 .588 .882; .706 .706 .745; .941 .667 .824; .706 .784 .99; .431 .843 .471];
...
%     ctrl_age_array(ai-3,3) = sum((ctrl_participant_info.age_yr == ai) & ~ctrl_reject.sub_reject);
    ...
    Exp3_age_array(ai-3,1) = sum(strcmp(Exp3_participant_info.sex, '남') & (Exp3_participant_info.age_yr == ai) );
    Exp3_age_array(ai-3,2) = sum(strcmp(Exp3_participant_info.sex, '여') & (Exp3_participant_info.age_yr == ai) );
    Exp3_age_array(ai-3,3) = sum((Exp3_participant_info.age_yr == ai) );
...
MB_Group{1} = Exp1_Behavior_table.acc_what;
MB_Group{2} = Exp1_Behavior_table.acc_whatwhen;
MB_Group{3} = Exp1_Behavior_table.acc_where;
MB_Group{4} = Exp1_Behavior_table.acc_wherewhen;
MB_Group{5} = Exp1_Behavior_table.acc_whatwhere;
MB_Group{6} = Exp1_Behavior_table.acc_fullem;
...
MB_Group{1} = Exp2_Behavior_table.select_acc_what;
MB_Group{2} = Exp2_Behavior_table.select_acc_whatwhen;
MB_Group{3} = Exp2_Behavior_table.select_acc_where;
MB_Group{4} = Exp2_Behavior_table.select_acc_wherewhen;
MB_Group{5} = Exp2_Behavior_table.select_acc_whatwhere;
MB_Group{6} = Exp2_Behavior_table.select_acc_fullem;
...
title(['1 crossing trial - EXP 2 vs WWW' ],'FontWeight','bold')
...
SB_Group{2} = Exp1_Behavior_table.select_ABD_acc_what(exp1_group_select ==gi);
SB_Group{5} = Exp1_Behavior_table.select_ABD_acc_whatwhen(exp1_group_select ==gi);
SB_Group{8} = Exp1_Behavior_table.select_ABD_acc_where(exp1_group_select ==gi);
SB_Group{11} = Exp1_Behavior_table.select_ABD_acc_wherewhen(exp1_group_select ==gi);
SB_Group{14} = Exp1_Behavior_table.select_ABD_acc_whatwhere(exp1_group_select ==gi);
SB_Group{17} = Exp1_Behavior_table.select_ABD_acc_fullem(exp1_group_select ==gi);
% SB_Group{2} = []

% gi = 2
MB_Group{3} = Exp1_Behavior_table.select_MBD_acc_what(exp1_group_select ==gi);
MB_Group{6} = Exp1_Behavior_table.select_MBD_acc_whatwhen(exp1_group_select ==gi);
MB_Group{9} = Exp1_Behavior_table.select_MBD_acc_where(exp1_group_select ==gi);
MB_Group{12} = Exp1_Behavior_table.select_MBD_acc_wherewhen(exp1_group_select ==gi);
MB_Group{15} = Exp1_Behavior_table.select_MBD_acc_whatwhere(exp1_group_select ==gi);
MB_Group{18} = Exp1_Behavior_table.select_MBD_acc_fullem(exp1_group_select ==gi);
...
% title
% legend({'Non Boundary', '', 'Boundary'});
legend({'WCDI', '', 'Visual', '', 'Visual + Audio'}, 'EdgeColor', 'none', 'Location', 'Northeast');
% if gi = 1
%     title(['Accuracy'],'FontWeight','bold')
% else
    title(['age 7.5-9.9 (WCDI & Exp1) 1 crossing'],'FontWeight','bold')
...
WWW_Group{1} = [ctrl_Behavior_table.cross0_MBD_acc_what(ctrl_group_select ==gi); ctrl_Behavior_table.cross0_ABD_acc_what(ctrl_group_select ==gi)];
WWW_Group{4} = [ctrl_Behavior_table.cross0_MBD_acc_whatwhen(ctrl_group_select ==gi); ctrl_Behavior_table.cross0_ABD_acc_whatwhen(ctrl_group_select ==gi)];
WWW_Group{7} = [ctrl_Behavior_table.cross0_MBD_acc_where(ctrl_group_select ==gi); ctrl_Behavior_table.cross0_ABD_acc_where(ctrl_group_select ==gi)];
WWW_Group{10} = [ctrl_Behavior_table.cross0_MBD_acc_wherewhen(ctrl_group_select ==gi); ctrl_Behavior_table.cross0_ABD_acc_wherewhen(ctrl_group_select ==gi)];
WWW_Group{13} = [ctrl_Behavior_table.cross0_MBD_acc_whatwhere(ctrl_group_select ==gi); ctrl_Behavior_table.cross0_ABD_acc_whatwhere(ctrl_group_select ==gi)];
WWW_Group{16} =[ctrl_Behavior_table.cross0_MBD_acc_fullem(ctrl_group_select ==gi); ctrl_Behavior_table.cross0_ABD_acc_fullem(ctrl_group_select ==gi)];
% SB_Group{2} = []

SB_Group{2} = [ctrl_Behavior_table.select_MBD_acc_what(ctrl_group_select==gi); ctrl_Behavior_table.select_ABD_acc_what(ctrl_group_select==gi)];
SB_Group{5} = [ctrl_Behavior_table.select_MBD_acc_whatwhen(ctrl_group_select ==gi); ctrl_Behavior_table.select_ABD_acc_whatwhen(ctrl_group_select ==gi)];
SB_Group{8} = [ctrl_Behavior_table.select_MBD_acc_where(ctrl_group_select ==gi); ctrl_Behavior_table.select_ABD_acc_where(ctrl_group_select ==gi)];
SB_Group{11} = [ctrl_Behavior_table.select_MBD_acc_wherewhen(ctrl_group_select ==gi); ctrl_Behavior_table.select_ABD_acc_wherewhen(ctrl_group_select ==gi)];
SB_Group{14} = [ctrl_Behavior_table.select_MBD_acc_whatwhere(ctrl_group_select ==gi); ctrl_Behavior_table.select_ABD_acc_whatwhere(ctrl_group_select ==gi)];
SB_Group{17} = [ctrl_Behavior_table.select_MBD_acc_fullem(ctrl_group_select ==gi); ctrl_Behavior_table.select_ABD_acc_fullem(ctrl_group_select ==gi)];
% SB_Group{2} = []

% gi = 2
MB_Group{3} = [ctrl_Behavior_table.cross2_MBD_acc_what(ctrl_group_select ==gi); ctrl_Behavior_table.cross2_ABD_acc_what(ctrl_group_select ==gi)];
MB_Group{6} = [ctrl_Behavior_table.cross2_MBD_acc_whatwhen(ctrl_group_select ==gi); ctrl_Behavior_table.cross2_ABD_acc_whatwhen(ctrl_group_select ==gi)];
MB_Group{9} = [ctrl_Behavior_table.cross2_MBD_acc_where(ctrl_group_select ==gi); ctrl_Behavior_table.cross2_ABD_acc_where(ctrl_group_select ==gi)];
MB_Group{12} = [ctrl_Behavior_table.cross2_MBD_acc_wherewhen(ctrl_group_select ==gi); ctrl_Behavior_table.cross2_ABD_acc_wherewhen(ctrl_group_select ==gi)];
MB_Group{15} = [ctrl_Behavior_table.cross2_MBD_acc_whatwhere(ctrl_group_select ==gi); ctrl_Behavior_table.cross2_ABD_acc_whatwhere(ctrl_group_select ==gi)];
MB_Group{18} = [ctrl_Behavior_table.cross2_MBD_acc_fullem(ctrl_group_select ==gi); ctrl_Behavior_table.cross2_ABD_acc_fullem(ctrl_group_select ==gi)];
...
%     title(['Accuracy'],'FontWeight','bold')
% else
    title(['(Exp 2 - multi) 0 1 2 crossing'],'FontWeight','bold')
...
%% [EXP3 - Chunking vs MB] ACC (selected trials = cross 1)
...
SB_Group{1} = Exp3_Behavior_table.select_Chunk_acc_what(Exp3_group_select ==1);
SB_Group{3} = Exp3_Behavior_table.select_Chunk_acc_whatwhen(Exp3_group_select ==1);
SB_Group{5} = Exp3_Behavior_table.select_Chunk_acc_where(Exp3_group_select ==1);
SB_Group{7} = Exp3_Behavior_table.select_Chunk_acc_wherewhen(Exp3_group_select ==1);
SB_Group{9} = Exp3_Behavior_table.select_Chunk_acc_whatwhere(Exp3_group_select ==1);
SB_Group{11} = Exp3_Behavior_table.select_Chunk_acc_fullem(Exp3_group_select ==1);
% SB_Group{2} = []

MB_Group{2} = Exp3_Behavior_table.select_MBD_acc_what(Exp3_group_select ==1);
MB_Group{4} = Exp3_Behavior_table.select_MBD_acc_whatwhen(Exp3_group_select ==1);
MB_Group{6} = Exp3_Behavior_table.select_MBD_acc_where(Exp3_group_select ==1);
MB_Group{8} = Exp3_Behavior_table.select_MBD_acc_wherewhen(Exp3_group_select ==1);
MB_Group{10} = Exp3_Behavior_table.select_MBD_acc_whatwhere(Exp3_group_select ==1);
MB_Group{12} = Exp3_Behavior_table.select_MBD_acc_fullem(Exp3_group_select ==1);
...
legend({'Chunk', '', 'Multi',}, 'EdgeColor', 'none', 'Location', 'Northeast');
% if gi = 1
%     title(['Accuracy'],'FontWeight','bold')
% else
    title(['[Chunk &  bndry] 1 crossing'],'FontWeight','bold')
...
%% [EXP 3 - MB] across within (1 crossing trial)
...
SB_Group{1} = Exp3_Behavior_table.select_Chunk_across_acc;%(MB_group_select ==1);
SB_Group{3} = Exp3_Behavior_table.select_Chunk_within_acc;%(MB_group_select ==1);

% SB_Group{2} = []

MB_Group{2} = Exp3_Behavior_table.select_MBD_across_acc;%(MB_group_select ==1);
MB_Group{4} = Exp3_Behavior_table.select_MBD_within_acc;%(MB_group_select ==1);
...
for bi = 1:2
    ...
    text((bi-1)*2+1.5, MBavg(bi*2)+ 0.4, disp, 'FontSize', 10,'fontweight','bold', 'HorizontalAlignment', 'center', 'Color', 'black');
...
% title
legend({'Chunking', '', 'Multi boundary'}, 'EdgeColor', 'none', 'Location', 'Northeast');
% title(['Accuracy'],'FontWeight','bold')
...
%% [EXP3 - MB] visual vs audio+visual Location chunking (1 crossing)
...
SB_Group = [Exp3_Behavior_table.select_Chunk_loc_chunking;];


MB_Group = [Exp3_Behavior_table.select_MBD_loc_chunking;];
